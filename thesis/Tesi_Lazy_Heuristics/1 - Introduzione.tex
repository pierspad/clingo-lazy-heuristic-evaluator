...
The evaluation covers three problem families, the Balanced Sum Problem (BSP), the Partner Units Problem (PUP), and the House Reconfiguration Problem (HRP), on both backends. The implementation is available at\footnote{\url{https://github.com/pierspad/clingo-lazy-heuristic-evaluator}}.
