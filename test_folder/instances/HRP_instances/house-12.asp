...
% persone=12 cose/persona=4 slack=2 legacy_fraction=0.5
...
thingLong(4). thingLong(8). thingLong(12). thingLong(16). thingLong(20). thingLong(24). thingLong(28). thingLong(32). thingLong(36). thingLong(40). thingLong(44). thingLong(48).

% --- dominio cabinet/stanze (con slack) ---
cabinetDomainNew(1..14).
roomDomainNew(1..14).
