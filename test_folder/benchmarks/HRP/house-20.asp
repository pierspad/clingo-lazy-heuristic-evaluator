...
% persone=20 cose/persona=4 slack=2 legacy_fraction=0.5
...
personTOthing(17,65..68).
personTOthing(18,69..72).
personTOthing(19,73..76).
personTOthing(20,77..80).

% --- cose lunghe (cabinet alto) ---
thingLong(4). thingLong(8). thingLong(12). thingLong(16). thingLong(20). thingLong(24). thingLong(28). thingLong(32). thingLong(36). thingLong(40). thingLong(44). thingLong(48). thingLong(52). thingLong(56). thingLong(60). thingLong(64). thingLong(68). thingLong(72). thingLong(76). thingLong(80).

% --- dominio cabinet/stanze (con slack) ---
cabinetDomainNew(1..22).
roomDomainNew(1..22).
...
legacyCabinet(9). legacyRoom(9). legacyRoomCabinet(9,9).
legacyCabinetThing(9,33..36).
legacyCabinet(10). legacyRoom(10). legacyRoomCabinet(10,10).
legacyCabinetThing(10,37..40).
