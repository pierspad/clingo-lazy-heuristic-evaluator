%% ============================================================
%% PUP per Alpha (Qh) - PRESO TALE E QUALE dai materiali dei paper.
%%
%% Origine: ALPHA/Evaluation/PUP/Double/encoding-alpha-prologheu-double.asp
%% (supplementary material di "Dynamic Aggregates in Expressive ASP
%% Heuristics for Configuration Problems"). E' l'antenato diretto degli
%% encoding PUP_gc.lp / PUP_la.lp di questa suite: stesse regole di scelta,
%% stessi predicati ausiliari, stessa euristica a quattro componenti.
%%
%% Le istanze double-*.asp in benchmarks/PUP sono byte-identiche a quelle
%% del supplementary material (verificato), quindi Alpha e clingo girano
%% letteralmente sugli stessi file.
%%
%% Da eseguire con -uqh.
%%
%% Nota sui livelli: qui zone e sensori sono separati da [W@1] contro
%% [W@0], cioe' dai livelli globali di Alpha. Gli encoding clingo di questa
%% suite ottengono lo stesso ordine con il flattening del livello nel peso
%% (offset +100000 sulle zone), perche' in clingo @P non ordina atomi
%% diversi - v. Sezione "Weights, Priorities, and Flattening".
%% ============================================================
